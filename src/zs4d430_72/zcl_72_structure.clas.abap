CLASS zcl_72_structure DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*    INCLUDE TYPE z72s_name    AS name.
**    INCLUDE TYPE st_address AS address.
*    INCLUDE TYPE z72s_address AS address.
...
CLASS zcl_72_structure IMPLEMENTATION.
...
*    DATA address TYPE st_address.
    DATA address TYPE z72s_address.
...
*    DATA person2 TYPE st_person_inc.
    DATA person2 TYPE z72s_person_inc.
